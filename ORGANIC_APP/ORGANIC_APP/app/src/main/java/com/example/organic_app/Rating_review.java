...
public class Rating_review extends AppCompatActivity implements View.OnClickListener, RatingBar.OnRatingBarChangeListener {
    RatingBar rt;
    EditText ed;
    Button bt;
    String raa="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rt.setOnRatingBarChangeListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        String url = "http://" + hu + ":5000/and_add_rating";
