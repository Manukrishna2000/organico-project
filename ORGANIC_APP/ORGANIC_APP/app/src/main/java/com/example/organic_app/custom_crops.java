...
public class custom_crops extends BaseAdapter {
    ...
    public custom_crops(Context applicationContext, String[] name, String[] description, String[] ytlink, String[] photo) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_sellers, null);
